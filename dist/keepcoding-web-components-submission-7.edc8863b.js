...
})({"iSiSh":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "09664157edc8863b";
"use strict";
...
},{}],"jnbdy":[function(require,module,exports,__globalThis) {
/*
todo-item
...
class TodoItem extends HTMLElement {
    ...
    attributeChangedCallback(name, oldValue, newValue) {
        if (name === "text") this.shadowRoot.querySelector("span").textContent = newValue;
        if (name === "is-checked") this.shadowRoot.querySelector("input").checked = this.hasAttribute("is-checked");
        if (name === "id" && oldValue === null) this._id = newValue;
    }
}
window.customElements.define("todo-item", TodoItem);

},{}]},["iSiSh","jnbdy"], "jnbdy", "parcelRequire1dc7", {})

//# sourceMappingURL=keepcoding-web-components-submission-7.edc8863b.js.map
